...
4. Keep a cancelled step message current while Pi has not reported its turn, because the extension
   must learn that a message it already delivered is cancelled and stop that turn.
...
- `npm run check`: 111 files, 1329 tests, statements 90.92%, branches 85.43%.
- `npm run test:e2e`: 14 tests passed.
...
wording. `test/component-vocabulary.test.ts` now fails when a retired term returns to one of those
surfaces. It reads only current surfaces, so a dated record and the ordinary language of network
hosts stay outside its scope.
...
| One vocabulary in every current surface                       | Production sources, protocol schemas, scripts, the Rust manifest, and current documentation contain no retired term; `test/component-vocabulary.test.ts` fails when `hosted`, a `host` owner value, or an old `host` request name returns. Dated records keep their own wording.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
