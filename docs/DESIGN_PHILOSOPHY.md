...
The workflow engine stays independent of Pi. The Pi extension connects the engine to a conversation. Resource managers own durable external resources. Viewers read recorded state without changing it.
