 ...
 * A later server kills a recorded process only when both values still match.
 */
export class ServerProcessRegistry {
  ...
  /** Reap only exact stale process identities recorded by an older server. */
  reapOrphans(): number[] {
