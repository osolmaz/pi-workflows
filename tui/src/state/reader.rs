...
const SCHEMA_DIGEST: [u8; 32] = [
    0x1e, 0xb8, 0xd4, 0x4a, 0x90, 0xf1, 0x58, 0x20, 0xa7, 0x92, 0x57, 0xf0, 0x76, 0x5f, 0xc7, 0x62,
    0x91, 0x24, 0x8d, 0x6b, 0x87, 0x1d, 0xfe, 0xaf, 0x79, 0xce, 0x0b, 0x38, 0x42, 0xfe, 0xc3, 0x27,
];
